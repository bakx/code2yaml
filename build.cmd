...
powershell -NoProfile -ExecutionPolicy UnRestricted -Command "$ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest 'https://cfhcable.dl.sourceforge.net/project/doxygen/rel-1.9.1/doxygen-1.9.1.windows.x64.bin.zip' -OutFile '%DoxygenLocation%\temp\doxygen.zip'"
